            ...
            <div className={styles.missionContainer}>
                ...
                <div className={styles.missionInfo}>
                    <p className={styles.infoText}>
                        ...
                        экономические возможности. Переработка отходов создает
                        новые рабочие места для создания продукции,
                        востребованной на экспортном и внутренних рынках. Таким
                        образом, проект является экономически устойчивым.
                        <br />
                        ...
                        смога в городе. Кроме того, настоящий проект поможет
                        предотвратить выделение других загрязняющих веществ,
                        таких как токсичная сажа, которые являются побочными
                        продуктами при сжигании хлопчатобумажной ткани и
